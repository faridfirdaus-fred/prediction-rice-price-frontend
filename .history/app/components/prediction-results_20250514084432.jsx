  ...
  return (
    ...
    >
      ...
      <motion.div variants={item} className="mb-2">
        <h1 className="text-2xl md:text-3xl text-center font-bold text-amber-800 dark:text-amber-400">
          Hasil Prediksi Harga Beras: {monthName} {year}
        </h1>
        <p className="text-gray-600 text-center dark:text-gray-300 mt-1">
      ...
      <motion.div
        variants={item}
        className="flex flex-col w-full  lg:flex-row gap-6"
      >
        {/* Price Cards Column */}
        <div className="w-full mt-10 lg:w-1/3 space-y-4">
