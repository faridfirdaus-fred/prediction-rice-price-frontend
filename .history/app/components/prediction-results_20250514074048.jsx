...
const PredictionResults = ({ data }) => {
  ...
  return (
    ...
    >
      <Card className="overflow-hidden border-0 shadow-lg rounded-xl bg-white dark:bg-slate-900">
        <CardHeader className="bg-amber-500 dark:bg-amber-600 py-4 px-6">
        ...
        <CardContent className="p-6 bg-gray-50 dark:bg-slate-900">
          <div className="mb-6">
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.5 }}
              className="rounded-xl bg-white dark:bg-slate-800 p-5 shadow-md border border-gray-100 dark:border-slate-700 mb-8"
            >
              <div className="flex mb-4 gap-2">
                <button className="px-6 py-2 bg-white dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-l-full font-medium text-amber-600 dark:text-amber-400">
                  Line Chart
                </button>
                <button className="px-6 py-2 bg-blue-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-600 rounded-r-full font-medium text-gray-600 dark:text-gray-400">
                  Area Chart
                </button>
              </div>
              <PriceChart
