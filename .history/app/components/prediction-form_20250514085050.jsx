...
const PredictionForm = () => {
  ...
  const NoDataDisplay = () => (
    <div className="flex flex-col items-center justify-center h-full min-h-[400px]">
      ...
      <h3 className="text-xl font-bold text-amber-800 dark:text-amber-400 mb-3">Belum Ada Prediksi</h3>
            ...
            >
              <Card className="bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 border-0 shadow-md">
                <CardContent className="p-4 flex items-start">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-amber-800 dark:text-amber-300">Tentang Prediksi</h4>
