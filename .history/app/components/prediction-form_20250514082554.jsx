            ...
            >
              <Card className="bg-gradient-to-br from-sky-50 to-teal-50 dark:from-sky-900/20 dark:to-teal-900/20 border-0 shadow-md">
                <CardContent className="p-4 flex items-start">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-sky-800 dark:text-sky-300">
                      Tentang Prediksi
                    </h4>
                    <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                      Model prediksi harga beras ini menggunakan metode machine
                      learning dengan data historis 5 tahun terakhir dan
                      mempertimbangkan faktor musiman.
                    </p>
                  </div>
                </CardContent>
              </Card>
